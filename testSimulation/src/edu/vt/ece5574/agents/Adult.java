...
public class Adult extends User{
	...
	public Adult(Simulation sim, String id, String buildingID, boolean bAppUser, int i, int j) {		
	...
	public boolean isTimeForActivity(SimState state)
	{
		...
		if (bld.getBuildingTime().getMinutes() < 15 && bld.getBuildingTime().getTimePeriod()==TIMEPERIOD.MORNING)
		{		 
			return true;
		}			
		else 
