...
public class Friend extends User {
	...
	public Friend(Simulation sim, String id, String buildingID, boolean bAppUser, int i, int j) {		
	...
	public boolean isTimeForActivity(SimState state)
	{
		...
		if (bld.getBuildingTime().getMinutes() < 15 && bld.getBuildingTime().getTimePeriod()==TIMEPERIOD.AFTERNOON)
		{		 
			return true;
		}			
		else 
